...
<head>
  ...
  <!-- Animate.css -->
  <link href="<?php echo DEFAULT_URL."/Assets"; ?>/vendors/animate.css/animate.min.css" rel="stylesheet">
      ...
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form name="login_form" method="POST">
            ...
            <div>
              <input type="text" class="form-control" name="input_email" placeholder="Username" required="" />
            </div>
            <div>
              <input type="password" class="form-control" name="input_password" placeholder="Password" required="" />
            </div>


            <div>
              <button  class="btn btn-default submit" type="submit" name="login_form">Log in</button >
        ...
        <section class="login_content">
          <form>
            ...
            <div class="separator">
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Emotion Analyzer!</h1>
              </div>
            </div>
          </form>
        </section>
